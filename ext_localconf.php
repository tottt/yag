...
if(TYPO3_MODE == 'BE') {
	...
	// ExtDirect
	//$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ExtDirect']['TYPO3.YAG.Categories.ExtDirect'] = t3lib_extMgm::extPath('yag') . 'Classes/Controller/CategoryController.php:Tx_Yag_Controller_CategoryController';
