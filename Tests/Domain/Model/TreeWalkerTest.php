 ...
 */
class Tx_Yag_Tests_Domain_Model_TreeWalkerTest extends Tx_Yag_Tests_BaseTestCase {

	/** @test */
	public function classExists() {
		$this->assertTrue(class_exists('Tx_Yag_Domain_Model_TreeWalker'));
	}
	...
	public function constructorAcceptsVisitorsAsArguments() {
		$firstVisitor = $this->getMock('Tx_Yag_Domain_Model_NestedSetVisitor', array(), array(), '', FALSE);
		$secondVisitor = $this->getMock('Tx_Yag_Domain_Model_NestedSetVisitor', array(), array(), '', FALSE);
		$treeWalker = new Tx_Yag_Domain_Model_TreeWalker(array($firstVisitor, $secondVisitor));
	}
	...
	public function constructorThrowsExceptionIfWrongClassGetsInjected() {
		$wrongVisitor = $this->getMock('Tx_Yag_Domain_Model_Item', array(), array(), '', FALSE);
		try {
			$treeWalker = new Tx_Yag_Domain_Model_TreeWalker(array($wrongVisitor));
		} catch (Exception $e) {
			return;
		}
	...
	public function visitorIsInvokedInCorrectOrder() {
		$node1 = Tx_Yag_Tests_Domain_Model_CategoryTreeBuilderTest::createCategory('1', 0, 0, 1, '1');
		$node2 = Tx_Yag_Tests_Domain_Model_CategoryTreeBuilderTest::createCategory('2', 0, 0, 1, '2');
		$node3 = Tx_Yag_Tests_Domain_Model_CategoryTreeBuilderTest::createCategory('3', 0, 0, 1, '3');
		$node4 = Tx_Yag_Tests_Domain_Model_CategoryTreeBuilderTest::createCategory('4', 0, 0, 1, '4');
		$node5 = Tx_Yag_Tests_Domain_Model_CategoryTreeBuilderTest::createCategory('5', 0, 0, 1, '5');
		$node6 = Tx_Yag_Tests_Domain_Model_CategoryTreeBuilderTest::createCategory('6', 0, 0, 1, '6');
		...
		$visitorMock = $this->getMock(Tx_Yag_Domain_Model_TreeWalkerVisitorInterface, array('doFirstVisit','doLastVisit'), array(), '', FALSE);
		$treeWalker = new Tx_Yag_Domain_Model_TreeWalker(array($visitorMock));
